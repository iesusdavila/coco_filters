...
void AnimalFilter::load_masks(const std::string& animal_name) {
    std::string base_path = ament_index_cpp::get_package_share_directory("buddy-filters") + "/imgs/animals_mask/" + animal_name + "/";

    // std::string base_path = "imgs/animals_mask/" + animal_name + "/";
