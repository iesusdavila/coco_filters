...
# me sale un error al importar FaceFilterBase debido a que estos dos archivos se encuentran en un mismo directorio, sin embargo, cuando lo llamo desde un directorio exterior si bien entra a este archivo no me deja importar FaceFilterBase
# por lo que no puedo probar el código de este archivo, pero se puede corregir aplicando el siguiente código:
import numpy as np
import cv2
